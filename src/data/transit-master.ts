...
export const TRANSIT_MASTER: Record<string, TransitMaster> = {
  ...
  'pluto-jupiter-hard': {
    title: '壮大な野望が実を結ぶ時',
    summary: '冥王星が木星に緊張角をとり、壮大な野望を抱き、思い描く理想をそのまま実現できるような勢いに恵まれる時期です。',
    events: [
      'プロジェクトの成功や組織内での出世',
      '独立・起業・まとまった財の獲得',
      '理想の相手との出会いや結婚による繁栄',
    ...
    howToSpend: '強い使命感に突き動かされるように大きく動ける時期です。理想の実現に向けて、思い切って行動してみましょう。',
    caution: '使命感の強さに飲み込まれて、独善的な行動に走らないよう気をつけてください。',
    importance: 8,
  },
